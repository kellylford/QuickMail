# QuickMail v0.5.1 Release Notes

These notes were published on the release itself; this file records them with the rest.
...
**Full changelog**: https://github.com/kellylford/QuickMail/compare/v0.5.0...v0.5.1
