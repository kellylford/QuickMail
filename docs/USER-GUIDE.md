...
- Auto-save shows "Auto-saved on this computer" instead of "Auto-saved". If auto-save ever cannot write to your computer at all, the message exists nowhere — so the compose window says so at the top, where a refused draft's reason appears, and the next successful save clears it.
