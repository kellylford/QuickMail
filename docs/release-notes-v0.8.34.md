...
- Press **Ctrl+Shift+M** to archive the selected message. **Delete** still works exactly as before (moves to Trash). The archive shortcut is rebindable in **Settings → Keyboard**, and Archive is in the Command Palette and on the message menu and context menu.
