...
- **User Guide:** rewrote the Microsoft account instructions around the Microsoft 365 / Outlook.com account type and added a **For Exchange / Microsoft 365 Administrators** section (admin consent, delegated permissions, roles, one-click consent URL, troubleshooting).
