...
and the status bar reads "9 messages (cached — syncing…)  Never synced  Connecting…  Client-side
rules: 1 active…". The probe runs fully offline against a cache, so these strings are the app's
