...
public class AttachmentModel
{
    ...
    /// <summary>
    /// The MIME Content-ID (without angle brackets) of a picture shown inside the message body,
    /// referenced from the HTML as <c>cid:</c> plus this value. Null for an ordinary attachment.
    /// </summary>
